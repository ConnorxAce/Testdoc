...
|------|---------|---------------------|
| `server.py` | Primary backend (~8300 lines) | All API routes, SSH device connections, session management |
...
| `app/web/static/js/show_version.js` | Version collection (~285 lines) | Show version fetch, display, CSV export |
| `app/web/static/js/firewall_rules_auto.js` | Rules Auto (Phase 1) (~1082 lines) | Base path, date folders, ensure/prepare/archive/deploy; calls `/api/firewall-rules-auto/*` |
| `app/web/templates/index.html` | Main UI (~1241 lines) | All page sections with DOM IDs |
...
**File:** `app/web/static/js/firewall_rules_auto.js` (~1082 lines)
