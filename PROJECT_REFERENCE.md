...
|------|---------|---------------------|
| `server.py` | Primary backend (~10205 lines) | All API routes, SSH device connections, session management |
...
| `app/web/static/js/firewall_rules_auto.js` | Rules Auto (Phase 1) (~1437 lines) | Base path, date folders, ensure/prepare/archive/deploy; calls `/api/firewall-rules-auto/*` |
...
**File:** `app/web/static/js/firewall_rules_auto.js` (~1437 lines)
